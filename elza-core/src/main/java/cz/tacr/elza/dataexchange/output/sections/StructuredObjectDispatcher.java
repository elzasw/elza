...
public class StructuredObjectDispatcher implements LoadDispatcher<ArrStructuredObject> {
    ...
    private ArrStructuredObject structuredData;
    ...
    @Override
    public void onLoad(ArrStructuredObject result) {
