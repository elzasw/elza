...
public class ArrDescItemExt extends ArrDescItem implements cz.tacr.elza.api.ArrDescItemExt<ArrChange, RulDescItemType,RulDescItemSpec, ParParty, RegRecord, ArrNode> {
