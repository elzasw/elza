...
public class DaoDigitizationServiceImpl implements DaoDigitizationService {
     ...
     */
    @Transactional
    public void digitizationRequestFinished(DigitizationRequestResult digitizationRequestResult) throws CoreServiceException   {
        try {
            ...
            requestService.setRequestState(request, cz.tacr.elza.api.ArrRequest.State.SENT, cz.tacr.elza.api.ArrRequest.State.ACCEPTED);
     ...
     */
    @Transactional
    public void digitizationRequestRevoked(RequestRevoked requestRevoked) throws CoreServiceException   {
        try {
            ...
            if (request != null) {
                requestService.setRequestState(request, cz.tacr.elza.api.ArrRequest.State.SENT, cz.tacr.elza.api.ArrRequest.State.REJECTED);
