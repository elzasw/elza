...
export function updateFormData(state, data, refTypesMap) {
    ...
    // ##
    if (currentNodeVersionId <= newNodeVersionId) { // rovno musí být, protože i když mám danou verzi, nemusím mít nově přidané povinné položky (nastává i v případě virtuálního klientského zvednutí nodeVersionId po zápisové operaci) na základě aktuálně upravené mnou
