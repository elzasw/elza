...
var AddRegistryVariantForm = class AddRegistryVariantForm extends AbstractReactComponent {
    constructor(props) {
        super(props);
...
module.exports = reduxForm({
        form: 'addRegistryVariantForm',
        fields: ['nameMain'],
        validate
    },state => ({
        initialValues: state.form.addRegistryVariantForm.initialValues,
        refTables: state.refTables
    }),
    {load: data => ({type: 'GLOBAL_INIT_FORM_DATA', form: 'addRegistryVariantForm', data})}
)(AddRegistryVariantForm)
