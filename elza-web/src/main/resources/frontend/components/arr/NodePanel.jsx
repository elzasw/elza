...
return true
    ...
    renderAccordion(form, recordInfo, daos, readMode) {
        ...
        return (
            <Shortcuts name='Accordion' key='content' className='content' ref='content' handler={this.handleShortcuts} tabIndex={1} global>
    ...
    render() {
        ...
        return (
            <Shortcuts name='NodePanel' key={'node-panel'} className={cls} handler={this.handleShortcuts} tabIndex={1} global>
