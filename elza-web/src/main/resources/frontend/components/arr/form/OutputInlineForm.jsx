    ...
    render() {
        ...
        return (
            <div className="edit-output-form-container">
                <form>
                    <Input type="text" label={i18n('arr.output.name')} disabled={disabled} {...name} {...decorateFormField(name, true)} />
                    <Input type="text" label={i18n('arr.output.internalCode')} disabled={disabled} {...internalCode} {...decorateFormField(internalCode, true)} />
                    <Input type="text" label={i18n('arr.output.outputType')} disabled value={outputType}/>
                    <Input type="select" label={i18n('arr.output.template')} disabled={disabled} {...templateId} {...decorateFormField(templateId, true)}>
