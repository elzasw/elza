...
const SubNodeDao = class SubNodeDao extends AbstractReactComponent {
    ...
    renderDao = (dao, index) => {
        ...
        let actions = [];
        actions.push(<Button onClick={() => {console.warn("TODO: SubNodeDao.edit.item")}} title={i18n('arr.fund.bulkModifications.action')}><Icon glyph='fa-pencil'/></Button>)
    ...
    render() {
        ...
        return <div className='node-dao'>
            ...
            <div className="actions"><Button onClick={() => {console.warn("TODO: SubNodeDao.edit")}} title={i18n('arr.fund.bulkModifications.action')}><Icon glyph='fa-pencil'/></Button></div>
