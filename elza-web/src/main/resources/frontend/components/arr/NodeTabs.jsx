...
return true
        ...
        var eqProps = ['versionId', 'fund', 'nodes', 'activeIndex', 'fundId', 'descItemTypes',
            'rulDataTypes', 'calendarTypes', 'packetTypes', 'packets', 'showRegisterJp', 'showRequestsJp', 'closed']
    ...
    render() {
        const {fund, nodes, activeIndex, versionId, rulDataTypes, showRegisterJp, showRequestsJp,
