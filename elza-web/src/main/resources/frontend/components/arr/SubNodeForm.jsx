...
class SubNodeForm extends AbstractReactComponent {
    ...
    handleCoordinatesDownload(objectId) {
        ...
        this.props.dispatch(downloadFile("arr-registry-coordinates-" + objectId, UrlFactory.exportArrCoordinate(objectId, versionId)));
    }

    handleJsonTableDownload(objectId) {
        const {versionId, typePrefix} = this.props;
        this.props.dispatch(downloadFile("arr-json-table-" + objectId + "-" + versionId, UrlFactory.exportItemCsvExport(objectId, versionId, typePrefix)));
    }
