...
var AddPartyGroupForm = class AddPartyGroupForm extends AbstractReactComponent {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        const {fields: {partyTypeId, recordTypeId, nameFormTypeId, nameMain, nameOther, validFrom, validTo, calendarTypeIdFrom, calendarTypeIdTo}, handleSubmit, onClose} = this.props;
        return (
            <div>
                <Modal.Body>
...
{load: data => ({type: 'GLOBAL_INIT_FORM_DATA', form: 'addPartyGroupForm', data})}
)(AddPartyGroupForm)
