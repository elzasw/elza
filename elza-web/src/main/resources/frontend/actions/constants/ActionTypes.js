...
export const FA_NODE_FORM_REQUEST = 'FA_NODE_FORM_REQUEST'
export const FA_NODE_FORM_RECEIVE = 'FA_NODE_FORM_RECEIVE'
...
export const RECORD_CHANGE_RECORD_DETAIL = 'RECORD_CHANGE_RECORD_DETAIL'
export const RECORD_SEARCH_RECORD = 'RECORD_SEARCH_RECORD'
