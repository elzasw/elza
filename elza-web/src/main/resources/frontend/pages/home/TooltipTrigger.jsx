...
class TooltipTrigger extends AbstractReactComponent {
    ...
    componentWillMount(){
        const {delay = 1000, showDelay, hideDelay, focusDelay, focusShowDelay, focusHideDelay} = this.props;
    ...
    showTooltip(show, delay) {
        console.log("###showTooltip", show, delay)
    ...
    render2() {
        ...
        return (
            <div ref="target" style={{ display: 'inline-block', background: 'red', border: '3px solid green' }}>
                <Button>
                    Click me!
                </Button>
    ...
    render() {
        ...
        return (
            <div
                ...
                onMouseOver={() => this.showTooltip(true, this.showDelay)}
                onMouseLeave={() => this.showTooltip(false, this.hideDelay)}
            >
                {children}
                <Overlay
        ...
        return (
            ...
            >
                ...
                <Overlay show={this.state.showTooltip}
                         placement={"right"}
                         target={() => ReactDOM.findDOMNode(this.refs.ttTarget)}
                >
                    <Tooltip
                        onMouseOver={() => this.handleTooltipHover(true)}
                        onMouseLeave={() => this.handleTooltipHover(false)}
