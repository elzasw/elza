var messages = {
    ...
    "exception.ext.EXTERNAL_RECORD_NOT_FOUND": "Nebyl nalezen vyexportovaný rejstřík s ID={id}",
    ...
    "exception.reg.EXISTS_CHILD": "Nelze smazat rejstříkové heslo, které má potomky'",
    "exception.reg.CANT_CREATE_WITH_TYPE_PARTY": "Nelze vytvořit rejstříkové heslo, které je navázané na typ osoby",
    "exception.reg.CANT_BE_SELF_PARENT": "Nelze nastavit rodiče rejstříkovému heslu sebe samotného",
    "exception.reg.REGISTRY_TYPE_DISABLE": "Nelze přidávat heslo do typu, který nemá přidávání hesel povolené",
    "exception.reg.PARENT_IS_NOT_HIERARCHICAL": "Nelze přidávat heslo k rodiči, který není hierarchický",
    "exception.reg.SCOPE_CANT_CHANGE": "Nelze změnit třídu rejstříku",
    "exception.reg.HIERARCHICAL_RECORD_HAS_CHILDREN": "Nelze změnit typ rejstříkového hesla na nehierarchický, pokud má heslo potomky",
    "exception.reg.CANT_CHANGE_WITH_TYPE_PARTY": "Nelze vytvořit rejstříkové heslo, které je navázané na typ osoby",
    "exception.reg.CANT_CREATE_WITH_OTHER_TYPE_PARTY": "Nelze změnit typ rejstříkového hesla osoby, který odkazuje na jiný typ osoby",
    "exception.reg.CANT_CHANGE_VALUE_WITH_PARTY": "Nelze editovat hodnotu rejstříkového hesla napojeného na osobu",
    "exception.reg.CANT_CHANGE_CHAR_WITH_PARTY": "Nelze editovat charakteristiku rejstříkového hesla napojeného na osobu",
    "exception.reg.CANT_CHANGE_EXID_WITH_PARTY": "Nelze editovat externí id rejstříkového hesla napojeného na osobu",
    "exception.reg.CANT_CHANGE_EXSYS_WITH_PARTY": "Nelze editovat externí systém rejstříkového hesla, které je napojené na osobu",
    "exception.reg.CHILD_AND_PARENT_DIFFERENT_TYPE": "Potomek rejstříkového hesla musí mít stejný typ jako jeho rodič",
    "exception.reg.USING_SCOPE_CANT_DELETE": "Nelze smazat třídu rejstříku, která je nastavena na rejstříku",
    ...
    "admin.perms.tabs.scopes": "Třídy rejstříků",
    "admin.perms.tabs.scopes.add.title": "Přidání tříd rejstříku",
    "admin.perms.tabs.scopes.items.scopeAll": "Všechny třídy rejstříku",
    ...
    "permission.AP_SCOPE_RD": "Čtení vybraného scope rejstříku",
    "permission.AP_SCOPE_RD_ALL": "Čtení všech scope rejstříku",
    "permission.AP_SCOPE_WR": "Zápis/úprava vybraného scope rejstříku",
    "permission.AP_SCOPE_WR_ALL": "Zápis/úprava všech scope rejstříku",
