...
realistic deployment for a filesystem archival repository — the per-entry round trip is the
...
unaffected by the fs changes; its repository fixture was aligned when N4 was resolved,
2026-08-11).
