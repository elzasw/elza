var messages = {
    ...
    "exception.arr.CANT_SET_INDEFINABLE": "Položku není možné nastavit jako 'Výjimka (nezjištěno, neexistuje)'.",
    "exception.arr.ALREADY_INDEFINABLE": "Položka již je nastavená jako 'Výjimka (nezjištěno, neexistuje)'.",
    ...
    "arr.fund.template.undefined": "Výjimka (nezjištěno, neexistuje)",
    ...
    "arr.fund.filterSettings.condition.undefined": "Výjimka (nezjištěno, neexistuje)",
    ...
    "subNodeForm.descItemType.title.notIdentified": "Nastavení hodnoty na Výjimka (nezjištěno, neexistuje)",
    ...
    "subNodeForm.descItemType.notIdentified": "Výjimka (nezjištěno, neexistuje)",
