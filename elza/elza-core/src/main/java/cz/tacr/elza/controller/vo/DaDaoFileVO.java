...
public class DaDaoFileVO {
    ...
    public DaDaoVO getDao() {
        return dao;
    }

    public void setDao(DaDaoVO dao) {
        this.dao = dao;
    }
    ...
    public DaDaoFileFolderVO getDaoFileFolder() {
        return daoFileFolder;
    }

    public void setDaoFileFolder(DaDaoFileFolderVO daoFileFolder) {
