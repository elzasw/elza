...
public class SectionContext {
    ...
    SectionContext(ArrFundVersion fundVersion,
        ...
        this.levelInfoLoader = new LevelInfoLoader(em, ctx.getBatchSize(), nodeCacheService, daLinkRepository, ctx.isIncludeAccessPoints(), ctx.isIncludeUUID(), ctx.isIncludeDaos());
