...
public class JsonTableComparator implements Comparator {

    private final Ctx ctx;

    public JsonTableComparator(final Ctx ctx) {
        this.ctx = ctx;
    }

    @Override
    public Predicate toPredicate(final QueryComparator comparator, final String value) {
        throw new IllegalArgumentException(unimplementedMessage(comparator, DataType.JSON_TABLE));
    }
}
