...
//    }
    ...
    private void sendReceipt(Object payload, StompHeaderAccessor requestHeaders) {
        ...
        log.debug("Sending receipt back to the client, sessionId: {}, receiptId: {}, payload: {}", sessionId, receiptId, payload);
