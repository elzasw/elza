...
import cz.tacr.cam.v2.client.ApiClient;
...
public class ApiClientCam extends ApiClient {
    ...
    protected void camInit(final String url, final String apiKey, final String apiValue) throws GeneralSecurityException {
        setBasePath(url);
