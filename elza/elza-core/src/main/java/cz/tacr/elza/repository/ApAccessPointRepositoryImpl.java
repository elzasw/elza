...
public class ApAccessPointRepositoryImpl implements ApAccessPointRepositoryCustom {
     ...
     */
    private FullTextQuery createFullTextQuery(org.apache.lucene.search.Query query, final Class<?> entityClass) {
    ...
    public List<ApCachedAccessPoint> findApCachedAccessPointisByQuery(String search,
        ...
        org.apache.lucene.search.Query query = buildQueryFromParams(queryBuilder, search, searchFilter, apTypeIdTree, scopeIds, state);
    ...
    private org.apache.lucene.search.Query buildQueryFromParams(QueryBuilder queryBuilder,
                                                                String search,
                                                                SearchFilterVO searchFilter,
                                                                Set<Integer> apTypeIdTree,
                                                                Set<Integer> scopeIds,
    ...
    private org.apache.lucene.search.Query process(QueryBuilder queryBuilder, SearchFilterVO searchFilterVO) {
        StaticDataProvider sdp = staticDataService.getData();
    ...
    private org.apache.lucene.search.Query processIndexCondDef(String value, String partTypeCode) {
    ...
    private org.apache.lucene.search.Query processValueCondDef(QueryBuilder queryBuilder, String value, String itemTypeCode, String itemSpecCode, String partTypeCode) {
