...
public abstract class AbstractControllerTest extends AbstractTest {
    ...
    protected static final String ITEM_TYPE_CODES = RULE_CONTROLLER_URL + "/itemTypeCodes";
    ...
    protected List<String> getItemTypeCodesByRuleSet(RulRuleSetVO rulRuleSetVO) {
        Response response = get(spec -> spec.param("code", rulRuleSetVO.getCode()), ITEM_TYPE_CODES);
