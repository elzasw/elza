var messages = {
    ...
    "exception.arr.CANT_SET_INDEFINABLE": "Položku není možné nastavit jako 'výjimka'.",
    "exception.arr.ALREADY_INDEFINABLE": "Položka již je nastavená jako 'výjimka'.",
    ...
    "exception.arr.ADMIN_USER_MISSING_FUND_CREATE_PERM":
        "K AS nelze přiřadit spráce (uživatele), protože nemá oprávnění zakládat AS",
    ...
    "exception.ext.EXTERNAL_RECORD_NOT_FOUND": "Nebyla nalezena vyexportovaná archivní entita s ID={id}",
    ...
    "exception.usr.NEED_CHANGE_PASSWORD": "Je třeba změnit i heslo",
    ...
    "ribbon.action.aip": "Archivní balíčky",
    ...
    "ribbon.action.admin.resetLocalStorage.title":
    ...
    "ribbon.action.ap.ext-search": "Import ze systému",
    "ribbon.action.ap.ext-syncs": "Fronta synchronizace",
    ...
    "arr.output.noSelection.message":
        "Prosím vyberte výstup ze seznamu nebo vytvořte nový. Pro vytvoření výstupu je potřeba povolit úpravy.",
    ...
    "arr.output.title.complete": "Dokončený výstup",
    ...
    "arr.fund.files.noMimetypeConfig":
        "V konfiguraci aplikace není definován žádný upravitelný formát souboru. Pro ručně psaný text je nutné nastavit alespoň jeden upravitelný formát. Administrátor může provést příslušné nastavení aplikace",

    "arr.fund.template.title": "Správa šablon",
    "arr.fund.template.empty": "Nejsou definovány žádné šablony",
    "arr.fund.template.undefined": "výjimka",
    ...
    "arr.fund.settings.panel.acordeon": "Akordeon",
    ...
    "arr.fund.detail.internalCode": "Interní kód",
    ...
    "arr.fund.filterSettings.condition.undefined": "Hodnota 'výjimka' (nezjištěno, neexistuje)",
    ...
    "arr.fund.internalCode": "Interní kód",
    ...
    "arr.daos.title.action.url": "Otevřít v uložišti",
    "arr.daos.title.action.copy": "Zkopírovat odkaz",
    "arr.daos.title.jp": "Připojeno k JP:",
    "arr.daos.title.description": "Popis",
    "arr.daos.title.code": "Kód",
    ...
    "arr.syncNodes.childrenNodes": "Včetně podřízených",
    "arr.refTemplates.title": "Správa šablon synchronizace JP",
    "arr.refTemplates.list.title": "Seznam šablon",
    "arr.refTemplates.noSelected": "Vyberte šablonu k úpravě",
    "arr.refTemplates.detail.basicInfo": "Základní údaje",
    "arr.refTemplates.detail.name": "Název",
    "arr.refTemplates.detail.itemTypeId": "Typ prvku popisu",
    "arr.refTemplates.detail.update": "Upravit základní údaje",
    ...
    "arr.refTemplates.mapping.fromItemSpecId": "Zdrojová spacifikace",
    "arr.refTemplates.mapping.toItemSpecId": "Cílová spacifikace",
    "arr.refTemplates.mapping.fromParentLevel": "Hledat v nadřazených úrovních",
    "arr.refTemplates.mapping.mapAllSpec": "Přebírat všechny specifikace",
    "arr.refTemplates.mapping.refTemplateMapSpecVOList": "Specifikace prvků",
    ...
    "arr.history.deleteQuestion":
        "Opravdu chcete provést nenávratné odstranění změn? (počet změn, které budou odstraněny: {0})",
    ...
    "arr.structure.modal.addMultiple.error.itemTypeIds.required":
        "Při přidání více položek najednou musí u alespoň jedné být nastavena inkrementace.",
    ...
    "registry.addNewRegistry": "Nová entita",
    "registry.all": "Vše",
    "registry.name": "Název",
    "registry.characteristics": "Charakteristika",
    "registry.shown": "Zobrazeno",
    "registry.deleteRegistryQuestion": "Opravdu chcete smazat archivní entitu?",
	...
	"ap.history.title.change.operace": "Operace",
    ...
    "ap.history.title.state.REV_ACTIVE": "revize v přípravě",
    "ap.history.title.state.REV_TO_APPROVE": "revize ke schválení",
    "ap.history.title.state.REV_TO_AMEND": "revize k doplnění",
	"ap.history.title.operation.AP_CREATE": "vytváření",
	"ap.history.title.operation.AP_UPDATE": "aktualizace",
	"ap.history.title.operation.AP_SYNCH": "synchronizace",
    ...
    "ap.push-to-ext.failed.intro": "Odeslání entity se nezdařilo z následujících důvodů:",
    "ap.push-to-ext.needConfirm.title": "Upozornění na možné nesrovnalosti",
    "ap.push-to-ext.needConfirm.intro": "Při odesílání entity byly zjištěny možné nesrovnalosti. Přejete si entitu odeslat přesto?",
    "ap.push-to-ext.needConfirm.confirm": "Odeslat entitu",
    ...
    "ap.ext-search.title": "Import ze systému",
    ...
    "admin.extSystem.syncDelay": "Interval synchronizace",
    ...
    "admin.extSystem.class.AiExternalSystemVO": "Poskytovatel AI služeb",
    ...
    "admin.bulk.title.runningThreadCount": "Běžících vláken",
    "admin.bulk.title.totalThreadCount": "Vláken celkem",
    "admin.bulk.title.runningThreads": "Běžící vlákna",
    "admin.bulk.title.noRunningThread": "Neběží žádné vlákno",
    "admin.bulk.title.beginTime": "Běží od {0}",
    "admin.bulk.title.currentId": "ID vazby #{0}",
    "admin.bulk.title.requestId": "ID fronty #{0}",
    ...
    "admin.perms.tabs.funds.perm.FUND_PUBLISH": "Publikování",
    ...
    "admin.perms.tabs.scopes.perm.AP_SCOPE_WR": "Zakládání a změny nových",
    "admin.perms.tabs.scopes.perm.AP_CONFIRM": "Schvalování archivních entit",
    "admin.perms.tabs.scopes.perm.AP_EDIT_CONFIRMED": "Změna schválených archivních entit",
    ...
    "admin.perms.tabs.advanced.perm.FUND_ISSUE_ADMIN_ALL": "Správa lektorování všech AS",
    ...
    "admin.user.add.shibboleth.message": "Ověřovací token je nastaven.",
    ...
    "permission.AP_SCOPE_WR": "Zakládání a změny nových archivních entit ve vybrané oblasti entit",
    "permission.AP_SCOPE_WR_ALL": "Zakládání a změny nových archivních entit ve všech oblastech entit",
    "permission.AP_CONFIRM": "Schvalování archivních entit ve vybrané oblasti entit",
    "permission.AP_CONFIRM_ALL": "Schvalování archivních entit ve všech oblastech entit",
    "permission.AP_EDIT_CONFIRMED": "Změna schválených archivních entit ve vybrané oblasti entit",
    "permission.AP_EDIT_CONFIRMED_ALL": "Změna schválených archivních entit ve všech oblastech entit",
    ...
    "permission.FUND_PUBLISH": "Publikování vybrané AS",
    "permission.FUND_PUBLISH_ALL": "Publikování všech AS",
    ...
    "extMapperForm.idForImport":
        'ID pro import záznamu "{0}". Kontaktujte správce a požádejte o import s mapováním vztahů.',
    ...
    "visiblePolicy.action.reset.confirm":
        "Opravdu vymazat? Po vymazání definice budou přebírána pravidla kontroly z nadřízené jednotky popisu.",
    ...
    "aip.form.contain": "Obsahuje",
    "aip.form.notContain": "Neobsahuje",
    "aip.form.between": "Je v rozmezí",
    "aip.form.equals": "Je přesné",
    "aip.form.notNull": "Nastavena hodnota",
    "aip.form.null": "Nenastavena hodnota",
    "aip.form.from": "Od",
    "aip.form.to": "Do",
    "aip.form.error.nan": "Musí být číslo",
    "aip.form.error.positiveNum": "Musí být kladné číslo",
    "aip.form.error.between": "Číslo od musí být menší než číslo do",
    "aip.form.error.emptyDate": "Datum musí být zadán",
    "aip.form.error.value": "Hodnota musí být vyplněna",
    "aip.form.update.title": "Výběr typu aktualizace AIP",
    "aip.form.update.type": "Typ aktualizace AIP",
    ...
    "aip.table.search": "Vyhledávání",
    "aip.filter.value.null": "Hodnota nenastavena",
    ...
    "aip.detail.title": "Detail AIP",
    "aip.detail.id": "Id",
    "aip.detail.code": "Kód aipu",
    "aip.detail.version": "Verze",
    "aip.detail.fund": "Archivní soubor",
    "aip.detail.institution.name": "Instituce",
    "aip.detail.institution.code": "Kód instituce",
    "aip.detail.unitdateFromTo": "Dotace od-do",
    "aip.detail.originator": "Původce",
    "aip.detail.ingestionCode": "Číslo přejímky",
    "aip.detail.referenceNumber": "Číslo jednací",
    "aip.detail.nadChangeCode": "Vnější změna",
    "aip.detail.size": "Velikost",
    "aip.detail.metadataLoad": "Načtena metadata",
