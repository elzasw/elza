    ...
    handleFragmentEdit = () => {
        this.props.dispatch(
            modalDialogShow(
                ...
                i18n('accesspoint.detail.name.new'),
                <FragmentFormModal
                    fragmentId={this.props.descItem.value}
                    onSubmit={() => {
        ...
        return (
            <div className="desc-item-value desc-item-value-parts">
                {!locked && !readMode && descItem.value == null && (
                    <Button variant="action" block ref="button" onClick={this.handleFragmentCreate}>
                ...
                {!locked && !readMode && descItem.fragment && (
                    <Button variant="action" ref="button" onClick={this.handleFragmentEdit}>
