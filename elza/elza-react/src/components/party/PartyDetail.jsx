                ...
                <div tabIndex={0} ref="partyDetail" className="party-detail">
                    <div className={headerCls}>
                        ...
                        <div className="header-content">
                            <div>
                                <div>
                                    <div className="title">
                                        {party.name} {partyDetail.data.accessPoint.invalid && '(Neplatné)'}
                                    </div>
                                </div>
                            </div>
                            <div>
                    ...
                    <div className="party-type">
                        ...
                        <div
                            ...
                            title={
                                party.accessPoint.comment ? party.accessPoint.comment : i18n('ap.state.title.noComment')
                            }
                        >
                            <span className="state-approval-label">
                                {StateApproval.getCaption(party.accessPoint.stateApproval)}
                            </span>
                            {party.accessPoint.scopeId && (
                            ...
                            if (TYPE === UI_PARTY_GROUP_TYPE.IDENT) {
                                    ...
                                    <div key={index}>
                                        ...
                                        >
                                            <PartyDetailNames
                                                party={party}
                                                partyType={partyType}
                                                onPartyUpdate={this.handlePartyUpdate}
                                                canEdit={canEdit}
                                            />
                                            ...
                                            {creators && creators.map((creator, index) => (
                                                <div key={index + '-' + creator.id} className="value-group">
                                                    <div className="desc-item-value desc-item-value-parts">
                                                        <PartyField
                                                            onCreate={this.handleAddParty.bind(this, creator)}
                                                            {...creator}
                                                        />
                                                        {canEdit && (
                                                            <Button
                                                                ...
                                                                onClick={() => {
                                                                    if (
                                                                        window.confirm(
                                                                            i18n('party.detail.creator.delete'),
                                                                        )
                                                                    ) {
                                            ...
                                            if (contentDefinition.hasOwnProperty(key)) {
                                                ...
                                                if (
                                                    ...
                                                    if (DEFINITION_TYPE === UI_PARTY_GROUP_DEFINITION_TYPE.TEXT) {
                                                        ...
                                                        DEFINITION_TYPE === UI_PARTY_GROUP_DEFINITION_TYPE.RELATION
                                                    ) {
                                                        const type = objectById(
                                                            partyType.relationTypes,
                                                            item.definition,
                                                            'code',
                                                        );
                                                        if (type) {
                                                        ...
                                                        DEFINITION_TYPE ===
                                                        UI_PARTY_GROUP_DEFINITION_TYPE.RELATION_CLASS
                                                    ) {
                                                        if (relationClassTypes[item.definition]) {
                                                            element = (
                                                                <PartyDetailRelationClass
                                                                    ...
                                                                    apTypesMap={apTypesMap}
                                                                    relationClassType={
                                                                        relationClassTypes[item.definition]
                                                                    }
                                                                    label={item.name}
                                                                    canEdit={canEdit}
                                                                />
                                ...
                                return (
                                    <CollapsablePanel
                                        ...
                                        {...events}
                                    >
                                        <div className="elements-container">{items}</div>
                                    </CollapsablePanel>
                                );
                            } else {
