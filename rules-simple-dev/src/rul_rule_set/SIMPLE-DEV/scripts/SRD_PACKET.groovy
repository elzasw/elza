...
static String toString(List<ArrStructuredItem> items, int packetLeadingZeros) {
    ...
    addNotEmpty(result, toStringValue(items, "SRD_PACKET_TYPE"), " ")
    addNotEmpty(result, toStringValue(items, "SRD_PACKET_PREFIX"))
    addNotEmpty(result, addZerosBefore(toStringValue(items, "SRD_PACKET_NUMBER"), packetLeadingZeros))
    addNotEmpty(result, toStringValue(items, "SRD_PACKET_POSTFIX"))
