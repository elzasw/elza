...
//            message("xmlui.discovery.SimpleSearch.search_label");
    ...
    private static final Message T_send_to_elza_result = message("xmlui.administrative.Navigation.context_search_send_to_elza_result");
    ...
    public void addBody(Body body) throws SAXException, WingException,
        ...
        if (StringUtils.isNotBlank(count)) {
            Division itemCount = body.addDivision("itemCount");
            itemCount.addPara(T_send_to_elza_result.parameterize(count));
        }
...
//        query.addPara(null, "button-list").addButton("submit").setValue(T_go);
    ...
    public SourceValidity getValidity() {
        SourceValidity sourceValidity = new SourceValidity() {
            @Override
            public int isValid() {
